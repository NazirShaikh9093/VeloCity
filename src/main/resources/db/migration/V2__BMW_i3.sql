...
VALUES ('BMW i3', '60', 'Manual', '4', '5',
'Ever since it was first unveiled, the BMW i3 has played a major role in bringing electric cars into the mainstream. With its funky looks, impressive performance and clever carbonfibre and aluminium construction, the i3 has shown buyers that electric cars dont have to be white goods – they can be lusted after.',
